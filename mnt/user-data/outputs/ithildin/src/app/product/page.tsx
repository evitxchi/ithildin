  ...
  return (
    <main style={{ background: 'var(--bg)' }}>
      ...
      <section style={{ padding: '160px 52px 60px', textAlign: 'center', maxWidth: 640, margin: '0 auto' }}>
        ...
        <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.88rem', fontWeight: 300, color: '#333', lineHeight: 1.65 }}>
      ...
      <section style={{ padding: '120px 52px', textAlign: 'center', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        <div className="reveal">
          ...
          <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.88rem', fontWeight: 300, color: '#333', marginBottom: 40 }}>
